...
function getApiBaseUrl() {
  ...
  const clientBase = isClient ? process.env.NEXT_PUBLIC_API_BASE_URL || "http://localhost:5000" : ""
  const serverBase = process.env.API_BASE_URL || process.env.NEXT_PUBLIC_API_BASE_URL || "http://localhost:5000"
